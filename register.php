          ...
          <div class="main-content_left-row">
            ...
            <div class="left-row-subarticles-container">
              ...
              <div class="subarticle-container">
                ...
                />
                <p>
                  NASA's new black hole visualizations showcase how gravity
                  warps light Images from computer simulations highlight the
                  'photon rings and more
                </p>
              </div>
            </div>
            <div class="" style="display: none">
              ...
              <h2>
                South Korean president declares Martial Law in South Korea
              </h2>
          ...
          <div class="main-content_right-row">
            ...
            <div class="right-row_article margin-top">
              ...
              <div class="right-row-article_info">
                ...
                <a href="" class="article-link"
                  ><p class="truncate">
                    Killing of insurance CEO reveals simmering anger at US
                    health system
                  </p></a
                >
              </div>
            ...
            <div class="right-row_article margin-top">
              ...
              <div class="right-row-article_info">
                ...
                <a href="" class="article-link">
                  <p class="truncate">
                    Nightclub stickers over smartphone rule divides the
                    dancefloor
                  </p></a
                >
              </div>
    ...
    <script>
      ...
      document
        ...
        .addEventListener("click", function () {
          ...
          // Redirect to another page or handle the registration process
